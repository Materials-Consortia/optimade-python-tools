...
class ParserTestNew(unittest.TestCase):
    ...
    def test_operators(self):
        ...
        self.assertIsInstance(self.parse('_exmpl_aax <= +.1e8 OR nelements >= 10 AND '
    ...
    def test_list_properties(self):
        ...
        self.assertIsInstance(self.parse('elements HAS "H" AND elements HAS ALL "H","He","Ga","Ta" AND elements HAS '
                                         'ONLY "H","He","Ga","Ta" AND elements HAS ANY "H", "He", "Ga", "Ta"'), Tree)

        # OPTIONAL:
        self.assertIsInstance(self.parse('elements HAS ONLY "H","He","Ga","Ta"'), Tree)
        self.assertIsInstance(self.parse('elements:_exmpl_element_counts HAS "H":6 AND '
