...
django_db_keys = {"natoms"           : "entry__natoms", 
            ...
            if len(children)==1:
                ...
                if parse_Tree.data=='comparison':
                    ...
                    if db_prop in django_db_keys.keys():
                        return op_fn(django_db_keys[db_prop],self.evaluate(children[2]))
                    else:
                        raise DjangoQueryError("Unknown property is queried : "+(db_prop))
