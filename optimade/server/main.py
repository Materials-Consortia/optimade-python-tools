...
@app.get(
    "/structures",
    response_model=Union[OptimadeStructureResponseMany, OptimadeErrorResponse],
...
@app.get(
    "/info",
    response_model=Union[OptimadeInfoResponse, OptimadeErrorResponse],
    response_model_skip_defaults=True,
    tags=["Structure"],
)
