...
class ServerConfig(BaseSettings):
    ...
    references_collection: Annotated[
        str, Field(description="Mongo collection name for /references endpoint resources")
    ] = "references"
    
    structures_collection: Annotated[
        str, Field(description="Mongo collection name for /structures endpoint resources")
    ] = "structures"
    
    trajectories_collection: Annotated[
        str, Field(description="Mongo collection name for /trajectories endpoint resources")
    ] = "trajectories"
