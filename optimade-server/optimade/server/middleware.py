...
from optimade.models.warnings import (
...
class AddWarnings(BaseHTTPMiddleware):
    """
    Add [`OptimadeWarning`][optimade.models.warnings.OptimadeWarning]s to the response.

    All sub-classes of [`OptimadeWarning`][optimade.models.warnings.OptimadeWarning]
    ...
    def showwarning(
        ...
        as an [`OptimadeWarning`][optimade.models.warnings.OptimadeWarning].
        This is equivalent to "standard behaviour".
        The second function will be called _after_ an
        [`OptimadeWarning`][optimade.models.warnings.OptimadeWarning] has been handled.

        An [`OptimadeWarning`][optimade.models.warnings.OptimadeWarning] will be
