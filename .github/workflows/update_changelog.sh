...
echo "Will actually be the tag name: ${GITHUB_REF#refs/tags/}, but is now 0.10.3"
invoke setver -v "v0.10.3"
...
git commit -m "Release ${GITHUB_REF#refs/tags/} (test, using 0.10.3)"
